...
# a binary operation has a left and right hand-side
class BinaryOperation:
    ...
    def __init__(self):
        self.type = None  # type of operation: addition or subtraction
        self.left = None  # left hand side
        self.right = None  # right hand side
