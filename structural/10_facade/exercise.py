...
class Generator:
  """Generates a 1-dimensional list of random digits in range 1 to 9."""
  def generate(self, count):
    return [randint(1,9) for x in range(count)]

class Splitter:
  """Takes a 2D list and splits it into all possible arrangements of 1D lists."""
...
class Verifier:
  """Takes a 2D list and verifies that the sum of elements in every sublist is the same."""
